...
export class DashboardComponent implements OnInit {
  ...
  startAnimationForBarChart(chart){
    ...
    public getAllCountOfCluster(): void{
        this.helperService.findTotalNewInCluster().subscribe((res: ResponseTotalKind[])=>{
                this.listCount = res;
    ...
    private genChart() {
        ...
        const dataCompletedTasksChart: any = {
            labels:this.listCount.map(x=>{
                return String(this.listCount.indexOf(x));
            }),
            series: [
